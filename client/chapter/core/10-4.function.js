...
// ! function 은 object 기능을 사용할 수 있다 => memoFibo.cache ={}
// 연산된것을 cache 라는 저장소에 넣어서 계산해준다
// 한번 연산된 값들은 cache 저장소에 넣어둔다
const memoFibo = (n) => {
  if (n <= 0) return 0;
  if (n <= 2) return 1;
  if (memoFibo.cache[n]) {
...
memoFibo.cache = {}; // 애를 함수안에 넣어서 관리할 수 있다.
